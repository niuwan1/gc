...
"""
logBasePath = "/home/xm/桌面/data/mylog/KerasDL/"
##rootPath = r'D:/data/HSI'
rootPath = r'/home/xm/桌面/遥感数据集'
import time
start = time.clock()
...
path.append('/home/xm/桌面/HSI-Classification-master/HSI Classification/HSI_ResNet/DataLoad')
import DataLoad
from DataLoad import *
from DataLoad import HSIDatasetLoad
from DataLoad import HSI_util
import numpy as np
from DataLoad import HSIDataLoad
...
##callbacks=[csvLog,reduce_lr,ealystop]
end = time.clock()
